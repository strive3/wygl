...
<form class="form-inline" name="info" id="info" action="Admin_listRepairlists.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            业主：
      <input class="form-control" type="text" id="real_name" name="real_name" value="${paramsRepairlist.real_name}" class="inputstyle" style="width:100px"/>&nbsp;
            房屋号：
      <input class="form-control" type="text" id="room_no" name="room_no" value="${paramsRepairlist.room_no}" class="inputstyle" style="width:100px"/>&nbsp;
