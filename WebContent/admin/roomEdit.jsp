...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">房屋管理&gt;&gt;${room!=null && room.room_id!=0?'编辑':'添加'}房屋</span>
</div>
   ...
   <tr>
     ...
     <table class="table table-bordered" width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          ...
          <td>
          	<input class="form-control" type="text" name="door_no" id="door_no" value="${room.door_no}"/>
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px">户型：</td>
          <td>
          	<input class="form-control" type="text" name="room_model" id="room_model" value="${room.room_model}"/>
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px">面积：</td>
          <td>
          	<input class="form-control" type="text" name="room_area" id="room_area" value="${room.room_area}"/>㎡
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 房屋状态：</td>
          <td>
          	<select class="form-control" id="room_flag" name="room_flag" Style="width:155px;">
