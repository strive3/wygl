...
<form class="form-inline" name="info" id="info" action="Admin_listSuggests.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            业主：
      <input class="form-control" type="text" id="real_name" name="real_name" value="${paramsSuggest.real_name}" class="inputstyle" style="width:100px"/>&nbsp;
