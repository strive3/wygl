...
<table class="form-inline" width="95%" align="center"  cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="50%" style="text-align:right;padding-right:5px;">
	        ...
	        &nbsp;　<input class="form-control" type="text" name="goPage" id="goPage" class="inputpagestyle" />
	        &nbsp;<input class="btn btn-default" type="button" value="GO" onclick="GoPage();" class="btnstyle"/>
	</td>
  </tr>
</table>  
