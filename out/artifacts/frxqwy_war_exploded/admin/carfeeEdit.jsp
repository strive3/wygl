...
<table width="800" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px;margin-bottom:10px;">
  <tr> 
     <td height="24">
       <Table class="table table-bordered" border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
   ...
   <tr>
     ...
     <table class="table table-bordered" width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        <tr>
          ...
          <td width="65%">
          	<select class="form-control" id="user_id" name="user_id" Style="width:150px;">
         ...
         <tr>
          ...
          <td width="65%">
          	<input class="form-control" type="text" name="carno" id="carno" value="${carfee.carno}"/>
          </td>
        </tr> 
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font> 车位费标准：</td>
          <td width="65%">
          	<input class="form-control" type="text" name="carfee_price" id="carfee_price" value="${carfee.carfee_price}"/> 元/㎡
          </td>
        </tr> 
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font> 缴费开始月份：</td>
          <td width="65%">
          	<input class="form-control" type="text" name="carfee_start" id="carfee_start" value="${carfee.carfee_start}"
        ...
        <tr>
          ...
          <td width="65%">
          	<input class="form-control" type="text" name="carfee_end" id="carfee_end" value="${carfee.carfee_end}"
          			 onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM'})"/>
          </td>
        </tr> 
        <tr>
          ...
          <td width="65%">
          	<input class="form-control" type="text" name="carfee_money" id="carfee_money" value="${carfee.carfee_money}"/>
          </td>
        </tr> 
     </table>
     </td>
