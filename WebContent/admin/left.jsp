			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">人事信息管理</a></h1>
				  <div class="content">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							  <td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					  ...
					  <ul class="MM">
						  <li><a href="Admin_listPeoples.action" target="MainFrame">人事信息查询</a></li>
						  <li><a href="Admin_addPeopleShow.action" target="MainFrame">新增人事信息</a></li>
					  </ul>
				  </div>
                  ...
                  <div class="content">
                      ...
                      <ul class="MM">
                          ...
                          <li><a href="Admin_addShopsShow.action" target="MainFrame">新增商铺信息</a></li>
                      </ul>
                  </div>
