...
public class AdminManager {
	 ...
	 * @return List<Shops>
	 */
	public List<Shops> listShopss(Shops shops, int[] sum) {

		if (sum != null) {
			sum[0] = shopsDao.listShopssCount(shops);
		}
		List<Shops> shopss = shopsDao.listShopss(shops);
		return shopss;
	}
	 ...
	 * @return Room
	 */
	public Shops queryShops(Shops shops) {

		Shops _shops = shopsDao.getShopss(shops);
	 ...
	 * @return void
	 */
	public void delShopss(Shops shops) {
		shopsDao.delShopss(shops.getIds().split(","));
	}
	...
	//==============================人事管理============================================
	public List<People> listPeoples(People people , int[] sum){
		if (sum != null) {
			sum[0] = peopleDao.listPeoplesCount(people);
		}
		List<People> peoples = peopleDao.listPeoples(people);
		return peoples;
	}

	public People queryPeople(People people) {

		People _people = peopleDao.getPeople(people);
