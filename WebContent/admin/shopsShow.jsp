...
<form name="info" id="info" action="Admin_listShopss.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
             商铺号：
      <input type="text" id="shops_no" name="shops_no" value="${paramsShops.shops_no}" class="inputstyle" style="width:100px"/>&nbsp;
            状态：
      <select id="shops_flag" name="shops_flag" class="selectstyle" Style="width:100px;">
